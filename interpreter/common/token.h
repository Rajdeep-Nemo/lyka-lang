...
typedef enum
{
    ...
    TOKEN_EQUAL, TOKEN_PLUS_EQUAL, TOKEN_MINUS_EQUAL, TOKEN_STAR_EQUAL, TOKEN_SLASH_EQUAL, TOKEN_MODULO_EQUAL,
    ...
    //10. Format specifier - %d,%f...
    TOKEN_FORMAT_SPECIFIER, TOKEN_ESCAPE,
} TokenType;
